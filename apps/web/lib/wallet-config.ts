...
export const WALLET_CONFIGS: WalletConfig[] = [
  ...
  // ========================================
  // EVM STANDARD (EOA) - HIDDEN BY DEFAULT
  ...
  // ========================================
  {
    ...
    name: 'Ethereum EOA',
    symbol: 'ETH',
    description: 'Ethereum Externally Owned Account',
    type: 'evm',
    chainId: 1,
    isTestnet: false,
    category: 'layer1',
  ...
  },
  {
    ...
    name: 'Base EOA',
    symbol: 'ETH',
    description: 'Base Externally Owned Account',
    type: 'evm',
    chainId: 8453,
    isTestnet: false,
    category: 'layer2',
  ...
  },
  {
    ...
    name: 'Arbitrum EOA',
    symbol: 'ARB',
    description: 'Arbitrum Externally Owned Account',
    type: 'evm',
    chainId: 42161,
    isTestnet: false,
    category: 'layer2',
  ...
  },
  {
    ...
    name: 'Polygon EOA',
    symbol: 'MATIC',
    description: 'Polygon Externally Owned Account',
    type: 'evm',
    chainId: 137,
    isTestnet: false,
    category: 'sidechain',
  ...
  },
  {
    ...
    name: 'Avalanche EOA',
    symbol: 'AVAX',
    description: 'Avalanche Externally Owned Account',
    type: 'evm',
    chainId: 43114,
    isTestnet: false,
    category: 'layer1',
